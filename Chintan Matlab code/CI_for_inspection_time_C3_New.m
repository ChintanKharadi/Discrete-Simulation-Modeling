...
c2=zeros(300,1);
 for i=1:1:300
     c2(1,i)=abs(component3(i,1)*choose_value(i,1));
 end


%%  Normal Distribution Generation based upon random numbers
m1 = mean(component3); %mean of the Random Inspection time (i.e. data)
Min1 = min(component3);
Max1 = max(component3);
n1= m1/(Max1-Min1);
x = 0:.00001:.99999;
...
time_avg(n) = insp2_time / (component3_count-1);
...
ci = sprintf('CI (95 percentage)for 20 replications :\t[%d,%d]',mean_lower,mean_upper);
disp(ci);
