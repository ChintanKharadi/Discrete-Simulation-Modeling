...
c1=zeros(300,1);
 for i=1:1:300
     c1(1,i)=abs(workstation2(i,1)*choose_value(i,1));
 end



%%  Normal Distribution Generation based upon random numbers
m1 = mean(workstation2); %mean of the Random Inspection time (i.e. data)
Min1 = min(workstation2);
Max1 = max(workstation2);
n1= m1/(Max1-Min1);
x = 0:.00001:.99999;
z1=normcdf(x);
...
time_avg1 = work2_time / (product2_count-1);
...
time_avg2 = work2_time / (product2_count-1);
end
...
ci = sprintf('CI (95 percentage)for 12 replications :\t[%d,%d]',CI1,CI2);
disp(ci);
