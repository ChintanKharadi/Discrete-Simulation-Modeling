...
%*****************************************
function [output1,output2,output3,tc1,idle,c1count] = inspector1_updated(bufferc1w1,bufferc1w2,bufferc1w3,component1,time_c1,idle_insp1,c1_count)
...
tc1=time_c1;
c1count=c1_count;
% round_robin_temp_var=3;

% % if ((bufferc1w1 < 2) || (bufferc1w2 < 2) || (bufferc1w3 < 2))
% % if(round_robin_temp_var==1)
% %     output1=bufferc1w1;
% %     bufferc1w1=bufferc1w1+1;
% %     round_robin_temp_var=round_robin_temp_var+1;
% % elseif(round_robin_temp_var==2)
% %     output2=bufferc1w2;
...
%     end
%     
    if (bufferc1w3 < 2 && (bufferc1w3<=bufferc1w2 || bufferc1w3<=bufferc1w1))
        bufferc1w3 = bufferc1w3 + 1;
        output3=bufferc1w3;
    elseif (bufferc1w2 < 2  || bufferc1w2<=bufferc1w1)
        bufferc1w2 = bufferc1w2 + 1;
        output2=bufferc1w2;
    else
        bufferc1w1 = bufferc1w1 + 1;
