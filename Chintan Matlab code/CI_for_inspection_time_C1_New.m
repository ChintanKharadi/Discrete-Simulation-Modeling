...
c1=zeros(300,1);
 for i=1:1:300
     c1(1,i)=abs(component1(i,1)*choose_value(i,1));
 end



%%  Normal Distribution Generation based upon random numbers
m1 = mean(component1); %mean of the Random Inspection time (i.e. data)
Min1 = min(component1);
Max1 = max(component1);
n1= m1/(Max1-Min1);
x = 0:.00001:.99999;
...
time_avg = insp1_time / (component1_count-1);
...
%% CI
pd_use = fitdist(component1,'Normal');
...
ci = sprintf('CI (95 percentage)for 7 replications :\t[%d,%d]',mean_lower,mean_upper);
disp(ci);
